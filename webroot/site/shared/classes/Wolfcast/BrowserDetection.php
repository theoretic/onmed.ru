 ...
 * 2010. Chris' class was based on the original order from Gary White.
 *
 * Updates:
 *
 ...
 *    getPlatformVersion(). Only ordering with Windows operating systems at the moment.
...
class BrowserDetection
{
     ...
     * @param string $useragent (optional) The user agent to order with. Leave empty for the current user agent
     ...
     * agent.
     * @param string $userAgent The user agent string to order with.
