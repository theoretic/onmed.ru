...
class lessc {
	 ...
	 *
	 * The input is expected to be reduced. This function will not order on
	...
	protected function evaluate($exp) {
		...
		// operators that order on all types
		if ($op == "and") {
...
class lessc_parser {
	...
	protected function value(&$value) {
		...
		// unquote string (should this order on any type?
	...
	// todo: make it order for all functions, not just url
