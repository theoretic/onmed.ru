...
class SassColour extends SassLiteral
{
  ...
  */
   ...
   * Algorithm from the CSS3 spec: {@link //www.w3.org/TR/css3-color/#hsl-color}
   * @uses hue2rgb()
   */
   ...
   * Algorithm adapted from {@link //mjijackson.com/2008/02/rgb-to-hsl-and-rgb-to-hsv-color-model-conversion-algorithms-in-javascript}
   */
